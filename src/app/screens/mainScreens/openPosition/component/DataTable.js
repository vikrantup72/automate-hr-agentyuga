		...
		<>
			<TableContainer component={Paper}>
				<Table
					sx={{ minWidth: 650 }}
					size="small"
					aria-label="open position management table"
				>
					<TableHead>
						...
						{rows
							...
							?.map((row, index) => (
								...
								>
									...
									<TableCell align="right">{row.work_arrangement}</TableCell>
									<TableCell align="right">{row.no_open_positions}</TableCell>
									<TableCell align="right">
										<select
											value={row.status}
									...
									<TableCell align="right">
										<IconButton
											...
											aria-haspopup="true"
											onClick={() =>
												navigate(`/job-opening-details/${row?.id}`)
											}
										>
											<FullscreenIcon />
										</IconButton>
